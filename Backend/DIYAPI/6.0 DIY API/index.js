...
app.patch("/jokes/:id",(req,res)=>{
    ...
    const patchJoke = {
      id: id,
      jokeText : req.body.text || getJoke.jokeText,
      jokeType : req.body.type || getJoke.jokeType,
    };
    const searchIndex = jokes.findIndex((joke)=> joke.id === id);
...
app.delete("/jokes/:id",(req,res)=>{
  const id = parseInt(req.params.id);
  const jokeDelete = jokes.findIndex((joke)=> joke.id === id);
  if(jokeDelete >= -1){
    jokes.splice(jokeDelete,1);
    res.sendStatus(200);
